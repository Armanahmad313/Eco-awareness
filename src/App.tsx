...
import { Leaf, Droplets, Wind, Sun, ArrowRight } from 'lucide-react';
...
function EnvironmentCard({ icon: Icon, title, description }: EnvironmentCardProps) {
  return (
      ...
      <div className="bg-green-900 text-white py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <button 
            ...
            className="bg-white text-green-900 px-8 py-3 rounded-full font-semibold hover:bg-green-50 transition-all duration-300 transform hover:scale-105 active:scale-95"
          >
            Join Our Movement
          </button>
        </div>
